...
If you are using Sketch (which, according to the statistics on packagist, you are not), and running `composer update` causes your application to break (please never update production dependencies without testing locally first), then there are two things you can do:
